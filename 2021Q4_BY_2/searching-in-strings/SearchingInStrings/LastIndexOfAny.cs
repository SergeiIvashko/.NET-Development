...
namespace SearchingInStrings
{
    public static class LastIndexOfAny
    {
        ...
        {
            // #4-1. Implement the method using String.LastIndexOfAny instance method.
        ...
        {
            // #4-2. Implement the method using String.LastIndexOfAny instance method.
            // See String.IndexOfAny method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexofany
        ...
        {
            // #4-3. Implement the method using String.LastIndexOfAny instance method.
            // See String.IndexOfAny method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexofany
