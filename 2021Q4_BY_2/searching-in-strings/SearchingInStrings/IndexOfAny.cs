...
namespace SearchingInStrings
{
    public static class IndexOfAny
    {
        ...
        {
            // #2-1. Implement the method using String.IndexOfAny instance method.
        ...
        {
            // #2-2. Implement the method using String.IndexOfAny instance method.
            // See String.IndexOfAny method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.indexofany
        ...
        {
            // #2-3. Implement the method using String.IndexOfAny instance method.
            // See String.IndexOfAny method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.indexofany
