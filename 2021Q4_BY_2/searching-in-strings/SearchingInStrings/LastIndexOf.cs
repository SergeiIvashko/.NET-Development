...
namespace SearchingInStrings
{
    public static class LastIndexOf
    {
        ...
        {
            // #3-1. Implement the method using String.LastIndexOf instance method.
        ...
        {
            // #3-2. Implement the method using String.LastIndexOf instance method.
            // See String.LastIndexOf method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
        ...
        {
            // #3-3. Implement the method using String.LastIndexOf instance method.
            // See String.LastIndexOf method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
        ...
        {
            // #3-4. Implement the method using String.LastIndexOf instance method.
            // See String.LastIndexOf method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            return str.LastIndexOf(value);
        }
        ...
        {
            // #3-5. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
        ...
        {
            // #3-6. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
            // See String.LastIndexOf and StringComparison documentation pages:
            // * https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            // * https://docs.microsoft.com/en-us/dotnet/api/system.stringcomparison
        ...
        {
            // #3-7. Implement the method using String.LastIndexOf instance method.
            // See String.LastIndexOf method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
        ...
        {
            // #3-8. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
            // See String.LastIndexOf and StringComparison documentation pages:
            // * https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            // * https://docs.microsoft.com/en-us/dotnet/api/system.stringcomparison
        ...
        {
            // #3-9. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
            // See String.LastIndexOf and StringComparison documentation pages:
            // * https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            // * https://docs.microsoft.com/en-us/dotnet/api/system.stringcomparison
            return str.LastIndexOf(value, startIndex, StringComparison.CurrentCulture);
        ...
        {
            // #3-10. Implement the method using String.LastIndexOf instance method.
            // See String.LastIndexOf method documentation page: https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
        ...
        {
            // #3-11. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
            // See String.LastIndexOf and StringComparison documentation pages:
            // * https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            // * https://docs.microsoft.com/en-us/dotnet/api/system.stringcomparison
        ...
        {
            // #3-12. Implement the method using String.LastIndexOf instance method. Analyze the unit tests, and use the correct StringComparison enumeration value.
            // See String.LastIndexOf and StringComparison documentation pages:
            // * https://docs.microsoft.com/en-us/dotnet/api/system.string.lastindexof
            // * https://docs.microsoft.com/en-us/dotnet/api/system.stringcomparison
