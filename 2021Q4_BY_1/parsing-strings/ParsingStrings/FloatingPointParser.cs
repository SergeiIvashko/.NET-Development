...
namespace ParsingStrings
{
    public static class FloatingPointParser
    {
        ...
        {
            // #19. Implement the method using "float.TryParse" method.
        ...
        {
            // #20. Implement the method using "float.Parse" method, and add exception handling.
            try
            {
        ...
        {
            // #21. Implement the method using "double.TryParse" method.
        ...
        {
            // #22. Implement the method using "double.Parse" method, and add exception handling.
            try
            {
        ...
        {
            // #23. Implement the method using "decimal.TryParse" method.
        ...
        {
            // #24. Implement the method using "decimal.Parse" method, and add exception handling.
            try
            {
