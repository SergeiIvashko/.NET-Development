...
namespace GettingArrayElementIndex
{
    public static class ForMethods
    {
        ...
        {
            // #2. Analyze the implementation of "GetLastIndexOf(uint[], uint, int, int)" method to see how "for" loop works, and implement the method using the "for" loop statement.
            if (arrayToSearch is null)
            {
                throw new ArgumentNullException(nameof(arrayToSearch));
            }
