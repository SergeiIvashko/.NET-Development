...
namespace PopulationTask
{
    public static class Population
    {
        ...
        public static int GetYears(int initialPopulation, double percent, int visitors, int currentPopulation)
        {
            ...
            int stepPopulation = initialPopulation;
            int countOfYears = 0;
            while (stepPopulation < currentPopulation)
            {
                stepPopulation = (int)(stepPopulation + ((double)stepPopulation * percent / 100)) + visitors;
                countOfYears++;
            }
