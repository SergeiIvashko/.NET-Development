...
namespace WorkingWithStrings
{
    public static class CopyingStrings
    {
        ...
        {
            // #8-1. Analyze unit tests for the method, and add the method implementation.
        ...
        {
            // #8-2. Analyze unit tests for the method, and add the method implementation.
            char[] destinationArray = destination.ToCharArray();
        ...
        {
            // #8-3. Analyze unit tests for the method, and add the method implementation.
            char[] destinationArray = destination.ToCharArray();
        ...
        {
            // #8-4. Analyze unit tests for the method, and add the method implementation.
