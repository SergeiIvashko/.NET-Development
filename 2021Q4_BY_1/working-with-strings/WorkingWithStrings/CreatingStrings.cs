...
namespace WorkingWithStrings
{
    public static class CreatingStrings
    {
        ...
        {
            // #2-1. Implement the method using String(Char, Int32) constructor
        ...
        {
            // #2-2. Implement the method using String(Char[]) constructor
        ...
        {
            // #2-3. Implement the method using String(Char[], Int32, Int32) constructor
