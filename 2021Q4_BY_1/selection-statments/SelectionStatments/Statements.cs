...
namespace SelectionStatments
{
    public static class Statements
    {
        ...
        {
            // #1: Add the method implementation. Restrictions:
        ...
        {
            // #2: Add the method implementation. Restrictions:
        ...
        {
            // #3: Add the method implementation. Restrictions:
        ...
        {
            // #4: Add the method implementation. Restrictions: the method can only use the cascaded if...else statement.
            if (userAge >= 65)
            {
        ...
        {
            // #5: Add the method implementation. Restrictions: the method can only use the cascaded if...else statement.
        ...
        {
            // #6: Add the method implementation. Restriction: the method can only use the cascaded if...else statement and conditional logical operators.
        ...
        {
            // #7: Add the method implementation. Restriction: the method can only use the switch statement.
            switch (dayOfWeek)
            {
        ...
        {
            // #8: Add the method implementation. Restrictions: the method can only use the cascaded if...else statement.  
        ...
        {
            // #9: Add the method implementation. Restrictions: the method can only use the switch statement.
            // Use Pattern matching https://docs.microsoft.com/en-us/dotnet/csharp/fundamentals/functional/pattern-matching
            switch (arg)
            {
                case sbyte _:
        ...
        {
            // #10: Add the method implementation. Restrictions: the method can only use the switch expression.
            // Use Pattern matching https://docs.microsoft.com/en-us/dotnet/csharp/fundamentals/functional/pattern-matching
        ...
        {
            // #11: Add the method implementation. Restrictions: the method can only use the switch statement.
            switch (month)
            {
                case Month.December:
                case Month.January:
        ...
        {
            // #12: Add the method implementation. Restriction: the method can only use the cascaded if...else statement and comparison operations.
        ...
        {
            // #13: Add the method implementation. Restriction: the method can only use the switch expression and comparison operations.
            // Don't use ToString() method, loops or decimal logarithm.
        ...
        {
            // #14: Add the method implementation. Restriction: the method can only use the cascaded if...else statement.
            if (month == 1)
            {
        ...
        {
            // #15: Add the method implementation. Restriction: the method can only use the switch statement.
            switch (month)
            {
                case 1:
                    {
        ...
        {
            // #16: Add the method implementation. Restriction: the method can only use the switch expression.
            1 => Month.January,
            2 => Month.February,
            3 => Month.March,
            4 => Month.April,
